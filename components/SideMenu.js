    ...
    return (
      <View style={{ backgroundColor: "#f0f0f0", flex: 1 }}>
        <View style={styles.sideHeader}>
          ...
          />
          <Text
            style={{ fontSize: ww(20), color: "white", fontWeight: "bold" }}
          >
            John Doe
          </Text>
          <Text style={{ fontSize: ww(16), color: "white" }}>
            male, 32 years
          </Text>
        </View>
        ...
        >
          ...
          <View>
            <Text style={{ fontSize: ww(16), color: "white" }}>Weight</Text>
        ...
        <View style={{ marginTop: hh(50) }}>
          <TouchableOpacity style={styles.menuBtn}>
            <FontAwesome
              ...
              size={20}
              style={[
                styles.drawrIcon && this.props.activeItemKey === "Inbox"
                  ? styles.currentIcon
                  : styles.drawrIcon
              ]}
            />
            <Text
              style={[
                styles.menuTxt && this.props.activeItemKey === "Inbox"
                  ? styles.currentText
                  : styles.menuTxt
              ]}
            >
